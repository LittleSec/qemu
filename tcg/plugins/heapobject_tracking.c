...
// Corresponding to pre_tb_helper_code
int after_block_exec_heapobject_cb(const TCGPluginInterface *tpi,
                                ...
                                const TranslationBlock* tb)
{
    ...
    if (pc == malloc_ret){
        ...
        SetValueInMap(k, v, allocated_objects);
...
// Corresponding to: pre_tb_helper_data
...
void tpi_init(TCGPluginInterface *tpi)
{
    ...
    tpi->pre_tb_helper_data = before_block_exec_heapobject_cb;
    tpi->pre_tb_helper_code = after_block_exec_heapobject_cb;
